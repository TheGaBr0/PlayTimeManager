...
/**
 * Handles configuration for command messages in the PlayTimeManager plugin.
 * Provides methods to access command-related configuration settings.
 */
public class CommandsConfiguration {
    ...
    /**
     * Constructs a new CommandsConfiguration instance.
     *
